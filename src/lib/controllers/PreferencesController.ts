...
export class PreferencesController {
	 ...
	 * Remove an allergy
	 */
	async removeAllergy(userId: string, allergy: string): Promise<UserPreferencesDao> {
		const prefs = await this.getPreferences(userId);
	 ...
	 */
	async addDietaryRestriction(userId: string, restriction: string): Promise<UserPreferencesDao> {
		const prefs = await this.getPreferences(userId);
	 ...
	 */
	async removeDietaryRestriction(userId: string, restriction: string): Promise<UserPreferencesDao> {
		const prefs = await this.getPreferences(userId);
	 ...
	 */
	async addExcludedIngredient(userId: string, ingredient: string): Promise<UserPreferencesDao> {
		const prefs = await this.getPreferences(userId);
	 ...
	 */
	async removeExcludedIngredient(userId: string, ingredient: string): Promise<UserPreferencesDao> {
		const prefs = await this.getPreferences(userId);
	 ...
	 */
	async setCuisinePreferences(userId: string, cuisines: string[]): Promise<UserPreferencesDao> {
	 ...
	 * Set caloric goal
	 */
	async setCaloricGoal(userId: string, caloricGoal: number | null): Promise<UserPreferencesDao> {
	 ...
	 */
	async setDefaultServings(userId: string, servings: number): Promise<UserPreferencesDao> {
