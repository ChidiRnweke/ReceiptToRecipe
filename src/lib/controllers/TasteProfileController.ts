...
export class TasteProfileController {
  ...
  async setIngredientPreference(
    ...
    return this.tasteProfileService.setIngredientPreference(
      userId,
      ingredientName,
      preference,
    );
  ...
  async removeIngredientPreference(userId: string, ingredientName: string) {
    return this.tasteProfileService.removeIngredientPreference(
      userId,
      ingredientName,
    );
  }
  ...
  async setCuisinePreference(
    ...
    return this.tasteProfileService.setCuisinePreference(
      userId,
      cuisineType,
      preference,
    );
