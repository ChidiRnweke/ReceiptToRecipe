...
const MOCK_DATA: RawReceiptData = {
	items: [
		{ name: 'chicken thighs', quantity: '2 lb', price: '$8.12', category: 'meat' },
		{ name: 'asparagus bundle', quantity: '1', price: '$3.80', category: 'produce' },
		{ name: 'yukon potatoes', quantity: '1kg', price: '$4.10', category: 'produce' }
	],
