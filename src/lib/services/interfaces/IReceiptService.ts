...
export interface IReceiptService {
	...
	getReceiptStatus(receiptId: string, userId: string): Promise<{ status: string; errorMessage?: string | null } | null>;
	...
	updateReceiptItem(receiptId: string, userId: string, itemId: string, data: UpdateReceiptItemInput): Promise<ReceiptItem>;
	addManualItem(receiptId: string, userId: string, data: UpdateReceiptItemInput): Promise<ReceiptItem>;
