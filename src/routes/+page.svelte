											...
											<div class="mt-1 flex items-center gap-2">
												<div class="h-1.5 w-16 rounded-full bg-border">
													<div
														...
														style="width: {activeList.stats.completionPercent}%"
													></div>
												</div>
												<span class="text-[10px] text-ink-muted">
													{activeList.stats.completionPercent}%
												</span>
											</div>
										{/if}
									{/await}
                            ...
                            {state.isAdded
												...
												<div class="font-ui flex-1 pl-2 text-sm leading-snug">
													<div class="flex items-center justify-between">
														...
														{#if inPantry && 'pantryMatch' in ingredient && ingredient.pantryMatch?.stockConfidence}
													...
													{:else if inPantry && 'pantryMatch' in ingredient && ingredient.pantryMatch?.lastPurchased}
														<p class="mt-0.5 text-[10px] text-text-muted italic">
