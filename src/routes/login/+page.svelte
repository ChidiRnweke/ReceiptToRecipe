<script lang="ts">
  ...
  import { ChefHat, Mail, Lock, Sparkles, ArrowRight } from "lucide-svelte";
...
<div class="flex min-h-screen flex-col items-center justify-center bg-[#FDFBF7] p-4 relative overflow-hidden">
  ...
  <!-- Decorative Elements -->
  <div class="absolute top-10 left-10 opacity-10 rotate-12 pointer-events-none">
      <ChefHat class="h-32 w-32 text-ink" />
  </div>
  ...
  <div class="relative z-10 w-full max-w-md">
    ...
    <div class="mb-8 text-center">
      ...
      <h1 class="font-display text-4xl text-ink">Welcome Back</h1>
      <p class="mt-2 font-serif text-ink-light italic">The kitchen is open.</p>
    </div>
