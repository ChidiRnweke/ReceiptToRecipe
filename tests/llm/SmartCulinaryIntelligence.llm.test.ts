...
import type { GeneratedRecipe, RecipeContext } from '../../src/lib/services/interfaces/ICulinaryIntelligence';
...
describeLLM('SmartCulinaryIntelligence (LLM Integration)', () => {
  ...
  describe('chat', () => {
    ...
    it('should respect a system prompt', async () => {
      ...
      const hasFrench = ['je', 'le', 'la', 'les', 'un', 'une', 'de', 'du', 'français', 'bonjour', 'parle']
  ...
  describe('generateRecipe', () => {
    ...
    it('should respect cuisine hint', async () => {
      ...
      const indianIndicators = ['indian', 'curry', 'masala', 'spice', 'turmeric', 'cumin', 'garam', 'tikka', 'biryani', 'tandoori', 'naan'];
